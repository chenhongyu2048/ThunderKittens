...
/**
 * @brief Makes a register tile upper right filled with a given value.
 *
 * @tparam RT The type of the register tile.
 * @param dst[in,out] The register tile to be filled.
 * @param src[in] The register tile to copy from.
 * @param row_idx[in] The row index to fill from and onwards to the top of the tile. (exclusive)
 * @param col_idx[in] The column index to fill from and onwards to the right. (inclusive)
 * @param val[in] The value to fill with.
 */
template<ducks::rt::row_layout RT>
